...
# DATABASES["default"] = dj_database_url.parse("postgresql://rakshana_user:0H1OEEz0Hcn6nBlDa0OsaX76xYiMaunQ@dpg-d1lph27diees73fvi8k0-a.oregon-postgres.render.com/rakshana")
...
#         "BACKEND": "channels_redis.core.RedisChannelLayer",
#         "CONFIG": {
#             "hosts": [("redis-12345.c1.us-east1-2.gce.cloud.redislabs.com", 6379)],
#         },
#     },
# }
import os
...
WSGI_APPLICATION = 'expense_backend.wsgi.application'
ASGI_APPLICATION = 'expense_backend.asgi.application'  # 👈 required for WebSockets
