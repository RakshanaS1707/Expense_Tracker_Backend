...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get("SECRET_KEY", "f1b1e77cbfc7c85f8a9c7f5ecaed4f")
...
WSGI_APPLICATION = 'expense_backend.wsgi.application'
# ASGI_APPLICATION = 'expense_backend.asgi.application'  # Uncomment if using WebSockets
...
database_url = os.environ.get("DATABASE_URL")
logger.info(f"DATABASE_URL: {database_url}")
if database_url and isinstance(database_url, str) and database_url.strip():
    try:
    ...
    logger.warning("DATABASE_URL is not set or invalid, using default local database settings.")
